...
describe("DocumentClass entity", () => {
  describe("constructor", () => {
    ...
    it("TU-F-browsing-16: constructor should assegna dipUuid, uuid, name e timestamp", () => {
    ...
    it("TU-F-browsing-17: constructor should imposta integrityStatus a UNKNOWN di default", () => {
      const dc = new DocumentClass(
        "dip-uuid",
        "dc-uuid",
        "Fatture",
    ...
    it("TU-F-browsing-18: constructor should id è null finché non viene persistito", () => {
      const dc = new DocumentClass(
        "dip-uuid",
        "dc-uuid",
        "Fatture",
  ...
  describe("fromDB", () => {
    ...
    it("TU-F-browsing-19: fromDB() should ricostruisce correttamente da una riga del database", () => {
    ...
    it("TU-F-browsing-20: fromDB() should usa UNKNOWN se integrityStatus è assente nella riga", () => {
      const row: DocumentClassRow = {
        id: 1,
        dipId: 1,
        uuid: "x",
  ...
  describe("setIntegrityStatus", () => {
    ...
    it("TU-F-browsing-21: setIntegrityStatus() should aggiorna lo stato di integrità", () => {
      const dc = new DocumentClass(
        "dip-uuid",
        "uuid",
        "Nome",
