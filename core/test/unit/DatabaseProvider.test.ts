...
describe("DatabaseProvider", () => {
  ...
  it("should fallback to homedir if no string is provided for dbPath", () => {
  ...
  it("should return the same db instance on subsequent calls", () => {
    const dbPath = "/custom/path/to/db.sqlite";
    const provider = new DatabaseProvider(dbPath);
