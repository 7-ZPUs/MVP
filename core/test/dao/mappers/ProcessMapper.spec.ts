...
describe("ProcessMapper", () => {
  ...
  it("maps persistence row to domain", () => {
    ...
    const entity = ProcessMapper.toDomain(row, metadataRows);
  ...
  it("uses UNKNOWN when status is missing or invalid", () => {
    ...
    expect(ProcessMapper.toDomain(missingStatus, metadataRows).getIntegrityStatus()).toBe(
      IntegrityStatusEnum.UNKNOWN,
    );
    expect(ProcessMapper.toDomain(invalidStatus, metadataRows).getIntegrityStatus()).toBe(
      IntegrityStatusEnum.UNKNOWN,
    );
  });
