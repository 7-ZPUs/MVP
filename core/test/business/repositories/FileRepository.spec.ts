...
describe("FileRepository", () => {
  ...
  // identifier: TU-F-B-38
  // method_name: getByDocumentId()
  // description: getByDocumentId, getByStatus e updateIntegrityStatus funzionano
  ...
  // identifier: TU-F-B-39
  // method_name: save()
  // description: save con fallback quando lastInsertRowid è falsy
  // expected_value: matches asserted behavior: save con fallback quando lastInsertRowid è falsy
  it("save con fallback quando lastInsertRowid è falsy", () => {
