...
describe("DocumentClassRepository", () => {
  ...
  // identifier: TU-F-B-32
  // method_name: save()
  // description: save e getById funzionano
  ...
  // identifier: TU-F-B-33
  // method_name: getByDipId()
  // description: getByDipId, getByStatus e updateIntegrityStatus funzionano
  ...
  // identifier: TU-F-B-34
  // method_name: search()
  // description: search restituisce risultati o null
  ...
  // identifier: TU-F-B-35
  // method_name: save()
  // description: save fallback per lastInsertRowid falsy e exception per fallimento
  // expected_value: matches asserted behavior: save fallback per lastInsertRowid falsy e exception per fallimento
  it("save fallback per lastInsertRowid falsy e exception per fallimento", () => {
