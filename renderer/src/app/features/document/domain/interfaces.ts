export interface DocumentoInformaticoType {
  IdDoc: IdDocType;
  ...
  DatiDiRegistrazione: DatiDiRegistrazioneType;
...
export interface IdDocType {
  ImprontaCrittograficaDelDocumento: ImprontaCrittograficaDelDocumentoType;
