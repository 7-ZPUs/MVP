...
export declare const IpcChannels: {
  ...
  readonly CHECK_DOCUMENT_INTEGRITY_STATUS: "check-integrity:document";
  readonly CHECK_FILE_INTEGRITY_STATUS: "check-integrity:file";
  readonly CHECK_PROCESS_INTEGRITY_STATUS: "check-integrity:process";
  readonly CHECK_DOCUMENT_CLASS_INTEGRITY_STATUS: "check-integrity:document-class";
  readonly CHECK_DIP_INTEGRITY_STATUS: "check-integrity:dip";
