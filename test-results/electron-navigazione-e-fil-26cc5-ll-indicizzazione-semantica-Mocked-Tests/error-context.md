...
- Name: electron/navigazione-e-filtri-parte-1/dip-navigation-mocked.spec.ts >> Navigazione e Filtri Parte 1 - Mocked >> [TS-26] Verificare che l'utente possa visualizzare lo stato dell'indicizzazione semantica
- Location: e2e/electron/navigazione-e-filtri-parte-1/dip-navigation-mocked.spec.ts:202:7
...
```ts
  ...
  106 |     });
  107 | 
  108 |     await page.route('**/__e2e__/mock-ipc', async (route) => {
